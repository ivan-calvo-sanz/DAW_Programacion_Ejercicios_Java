...
public class Banco implements Serializable {
    ...
    /**
     * METODO lista Info de cada Cuenta Bancaria existente en el array
     * cuentasBancarias
     */
    public String listadoClientes() {
        String devuelve ="LISTADO CLIENTES" + "\n";
        try {
            for (int i = 0; i < this.cuentasBancarias.size(); i++) {
                devuelve +=(i+1)+"- Nombre: "+ this.cuentasBancarias.get(i).getPersona().getNombre()+" | CCC: "+this.cuentasBancarias.get(i).getIban()+"\n";
            }
            devuelve +="\n"+"Número total de cuentas existentes = "+this.cuentasBancarias.size()+" Cuentas";
        } catch (Exception e) {
            System.err.println("Se ha producido un error al listar las Cuentas |Error: " + e);
        }
        return devuelve;
