...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        int opcion;
            ...
            do {  //para salir del programa               
                ...
                switch (opcion) {
                    case 1:
                        concesionario = nuevoVehiculo(concesionario);
                        System.out.println("*************************");
                        System.out.print(MENU_PRINCIPAL);
                        break;
                    case 2:
    ...
    /**
     * METODO case 1
     * genera un objeto Concesionario, realiza la comprobación de los
     * datos insertados por consola
     */
    private static Concesionario nuevoVehiculo(Concesionario concesionario) {
        ...
        } while (!Vehiculo.validaMatricula(matricula));
        ...
        } while (!Vehiculo.validaNombrePropietario(nombrePropietario));

        String dniPropietario;
        do {
            dniPropietario = PedidorDeDatos.pedirString("DNI del propietario:");
        } while (!Vehiculo.validaDNI(dniPropietario));
        ...
        if (insertado == -2) {
            ...
            System.out.println("El Concesionario estaba vacío. Se ha creado el Concesionario e insertado el primer vehículo");
        } else if (insertado == 0) {
    ...
    /**
     * METODO case 2
     * muestra por pantalla los vehículos que contiene el Concesionario
     */
    private static void listarVehiculos(Concesionario concesionario) {
        concesionario.listaVehículos();
    }

    /**
     * METODO case 3
     * lanza una búsqueda de un Vehículo en el Concesionario
     */
    private static void buscarVehiculos(Concesionario concesionario) {
        ...
        String imp = concesionario.buscaVehiculo(matricula);
        if (imp.equals("null")) {
    ...
    /**
     * METODO case 4
     * lanza para modificar los kms de un Vehículo perteneciente al Concesionario
     */
    private static void modificarKmsVehiculo(Concesionario concesionario) {
        ...
        if (concesionario.actualizaKms(matricula, numKm) == true) {
    ...
    /**
     * METODO case 5
     * lanza para borrar un Vehículo del Concesionario
     */
    private static void eliminaVehiculo(Concesionario concesionario) {
        ...
        if (concesionario.eliminaVehiculo(matricula) == true) {
