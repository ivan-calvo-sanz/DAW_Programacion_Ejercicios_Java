...
public class Principal {
     ...
     * @return void
     */
    private static Vehiculo nuevoVehiculo(Vehiculo vehiculo) {
        try {
            //entrada.useDelimiter("\n");  //Para evitar problemas de introducir espacios en blanco
            String marca = PedidorDeDatos.pedirString("Marca del Vehiculo:");
            String matricula = PedidorDeDatos.pedirString("Matrícula del Vehiculo:");
            int numKm = PedidorDeDatos.pedirInt("Número de kilómetros (km):");
            ...
            String descripcion = PedidorDeDatos.pedirString("Descripcion del Vehiculo:");
            double precio = PedidorDeDatos.pedirDouble("Precio del Vehiculo (€):");
            String nombrePropietario = PedidorDeDatos.pedirString("Nombre del propietario:");
            String dniPropietario = PedidorDeDatos.pedirString("DNI del propietario:");
